...
<body>
    ...
    <thead>
        <tr><th class="danger">serialnumber</th>
            <th class="info">TU Registration Code</th><th class="info">Full Name</th><th class="info">Project</th><th class="info">Project Area</th>
        </thead>
	<tbody>
        <?php
        ...
        <td><?php echo '<a href="'.$row["Project"].'">View Project</a>'; ?></td>
        <td><?php echo $row["ProjectArea"]; ?></td>
                </tr>
