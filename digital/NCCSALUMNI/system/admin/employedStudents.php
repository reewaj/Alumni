                ...
                <div class="container">
                    ...
                    <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="employedStudents.php">Employed Students </a></li>
      ...
      <form method="POST" action="displaysearchedresulttable.php" class="form-horizontal">
        ...
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-12">
                    <div id="the-basics">
                      <input class="form-control" type="text" name="searchValue" placeholder="Enter Name of Students"> <!--Add typehead -->
        ...
        <?php
		include "include.php";
        include "displayEmployedTable.php";
