...
<div class="container">
    ...
    <div class="card">
     <!--  <h2>Search unemployed students information here</h2>
      <form method="POST" action="searchUnempStudent.php">
        <input align="right" type="text" name="searchName" placeholder="Enter Fullname of Student"  required>
        <input type="submit" name="submit" value="Search ">
      </form> -->
      <h2><center>List of Unemployed Students</center></h2>
        <?php
            include('C:\xampp\htdocs\digital\NCCSALUMNI\system\MainClass.php');
            $obj=new MainClass;
            $obj->displayUnemployedTable();
        ?>
    </div>
