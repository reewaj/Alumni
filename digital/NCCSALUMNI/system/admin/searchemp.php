...
<div class="container">
     ...
     <!--  <h2>Search employed students inforamtion here</h2>
      <form method="POST" action="searchEmpStudent.php">
        <input align="right" type="text" name="searchName" placeholder="Enter Fullname of Student"  required>
        <input type="submit" name="submit" value="Search ">
      </form> -->
      <h2><center>List of Employed Students</center></h2>
        <?php
          
include('C:\xampp\htdocs\digital\NCCSALUMNI\system\MainClass.php');
          $obj=new MainClass;
          $obj->displayEmployedTable();
        ?>
    </div>
